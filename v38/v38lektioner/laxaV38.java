...
public class laxaV38 {
	...
	public static void main(String[] args) {
		...
		}	// Genom att skriva <= och >= istället för att bara skriva < eller > så löste jag problemet med att	den inte skrev ut det högsta eller lägsta talet om två variabler delade denna egenskap
	}
